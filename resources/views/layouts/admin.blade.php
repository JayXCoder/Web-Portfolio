        ...
        <nav class="flex-1 space-y-1 overflow-y-auto p-3">
            @php
                $nav = [
                    ...
                    ['route' => 'admin.blog-posts', 'label' => 'Blog', 'match' => 'admin.blog-posts*', 'icon' => 'M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z'],
                    ['route' => 'admin.blog-comments', 'label' => 'Blog Comments', 'match' => 'admin.blog-comments*', 'icon' => 'M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.076-4.076a1.526 1.526 0 0 1 1.037-.443 48.282 48.282 0 0 0 5.432-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z'],
                    ['route' => 'admin.knowledge', 'label' => 'Knowledge', 'match' => 'admin.knowledge*', 'icon' => 'M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5m4.75-11.396c.251.023.501.05.75.082m-.75-.082a24.301 24.301 0 0 0-4.5 0m4.5 0v-.75A2.25 2.25 0 0 0 7.5.104h-1.5a2.25 2.25 0 0 0-2.25 2.25v.75m0 0c-.251.023-.501.05-.75.082m.75-.082V8.25m0 0v.568a2.25 2.25 0 0 0 .659 1.591L8.5 14.5m-5.5-11.314A48.394 48.394 0 0 0 3 5.25c0 2.166.142 4.299.417 6.39M3 3.186v.568m8.25-.65c.251.023.501.05.75.082m-.75-.082v5.714c0 .597.237 1.17.659 1.591L16 14.5m-4.75-11.396v-.75A2.25 2.25 0 0 1 13.5.104H15a2.25 2.25 0 0 1 2.25 2.25v.75m0 0c.251.023.501.05.75.082m-.75-.082V8.25m0 0v.568a2.25 2.25 0 0 1-.659 1.591L12.5 14.5m5.5-11.314c.275 2.091.417 4.224.417 6.39 0 .216-.001.432-.004.647M8.5 14.5l-2 2.5h11l-2-2.5m-7 0h7'],
