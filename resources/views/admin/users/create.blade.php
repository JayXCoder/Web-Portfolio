...
@push('styles')
    <style>
        ...
        .btn-primary:hover {
            ...
            border-color: #ab3bf6 !important;
            color: #ab3bf6 !important;
                ...
                <div class="col-lg-8">
                    <div class="admin-card p-4">
                        ...
                        <div class="admin-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0 opacity-75">Create a new admin or viewer account</p>
                                </div>
                                <a href="{{ secure_url(route('admin.users')) }}" class="btn btn-light">
                        ...
                        <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data"
                            data-secure="true" onsubmit="return submitSecurely(this)">
                            @csrf
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                <a href="{{ secure_url(route('admin.users')) }}" class="btn btn-secondary">
