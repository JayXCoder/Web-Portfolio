...
@section('title', 'Create Work Experience - Admin - Jawahar Ganesh @ Jay')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="page-subtitle">Add a new work experience entry to your portfolio</p>
                    </div>
                    <div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.work-experiences.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return submitSecurely(this)">
                        @csrf
                                ...
                                <div class="form-section mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('responsibilities') is-invalid @enderror" 
                                                  ...
                                                  rows="4">{{ old('responsibilities') }}</textarea>
                                ...
                                <div class="form-section mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('technologies') is-invalid @enderror" 
                                                  ...
                                                  name="technologies" 
                                                  rows="2" 
                                                  placeholder="Enter technologies separated by commas (e.g., PHP, Laravel, MySQL, JavaScript)">{{ old('technologies') }}</textarea>
                                        @error('technologies')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('skills_gained') is-invalid @enderror" 
                                                  ...
                                                  name="skills_gained" 
                                                  rows="2" 
                                                  placeholder="Enter skills separated by commas (e.g., Team Leadership, Project Management, Agile Development)">{{ old('skills_gained') }}</textarea>
                                        @error('skills_gained')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('achievements') is-invalid @enderror" 
                                                  ...
                                                  name="achievements" 
                                                  rows="2" 
                                                  placeholder="Enter achievements separated by commas (e.g., Increased efficiency by 30%, Led team of 5 developers)">{{ old('achievements') }}</textarea>
                                        @error('achievements')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="logo-upload-section">
                                        <div class="logo-upload-area">
                                            ...
                                            <div class="logo-upload-placeholder" onclick="document.getElementById('company_logo').click()">
                                                ...
                                                <p class="text-white mb-0">Click to upload logo</p>
                        ...
                        <div class="form-actions">
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary-custom">
                                    <i class="fas fa-save me-2"></i>Create Work Experience
                                </button>
                            </div>
                        </div>
                    </form>
