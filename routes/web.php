...
// AI Chat routes
Route::get('/chat', [RagChatController::class, 'index'])->name('chat');
Route::post('/chat/send', [RagChatController::class, 'sendMessage'])->name('chat.send');
Route::post('/chat/stream', [RagChatController::class, 'stream'])->name('chat.stream');
Route::get('/chat/status', [RagChatController::class, 'status'])->name('chat.status');
...
Route::prefix('admin')->name('admin.')->middleware('force.https')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware('admin')->group(function () {
            Route::get('/knowledge', [AdminKnowledgeController::class, 'index'])->name('knowledge');
            Route::post('/knowledge/reindex', [AdminKnowledgeController::class, 'reindex'])->name('knowledge.reindex');
            Route::get('/knowledge/linkedin/connect', [AdminKnowledgeController::class, 'connect'])->name('knowledge.linkedin.connect');
            Route::get('/knowledge/linkedin/callback', [AdminKnowledgeController::class, 'callback'])->name('knowledge.linkedin.callback');
            Route::post('/knowledge/linkedin/sync', [AdminKnowledgeController::class, 'sync'])->name('knowledge.linkedin.sync');
            Route::delete('/knowledge/linkedin/disconnect', [AdminKnowledgeController::class, 'disconnect'])->name('knowledge.linkedin.disconnect');
            Route::post('/knowledge/linkedin/import', [AdminKnowledgeController::class, 'import'])->name('knowledge.linkedin.import');
            Route::get('/knowledge/debug', [ChatController::class, 'debug'])->name('knowledge.debug');
        });
